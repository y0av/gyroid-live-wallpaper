...
android {
    ...
    // repo carries no secrets. If SIGNING_STORE_FILE is absent (local dev, or a
    // fork without secrets) the release build falls back to the debug key so an
    // installable APK is still produced.
    signingConfigs {
        create("release") {
